                            ...
                            <form role="form" enctype="multipart/form-data" @submit.prevent="updatePost()">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <img v-if="form.image" :src="form.image" alt="post thumbnail" class="rounded mt-2" width="100" height="100"> -->
                                        <img v-if="form.image" :src="updateImage()" alt="post thumbnail" class="rounded mt-2" width="100" height="100">
...
export default {
    ...
    methods: {
        ...
        updateImage() {
            ...
            if(img.length > 100 || img.includes('https')){
                return this.form.image
            }else{
                //return "/uploadimage/" + this.form.photo
                return `/uploadimage/${this.form.image}` // es6
            }
        },
        updatePost(){
            this.form.put(`/post/${this.$route.params.id}`)
                .then((response) => {
